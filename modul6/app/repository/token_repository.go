...
// FindActive hanya mengembalikan token yang belum dicabut dan belum expired
...
// RevokeAllForUser dipakai saat password diganti atau terdeteksi penyalahgunaan token
