...
// JWTManager mengelola pembuatan dan parsing JWT
...
// GenerateAccess membuat access token berumur pendek (HS256)
...
// Parse memverifikasi signature dan expiry token, mengembalikan identitas user
func (m *JWTManager) Parse(tokenString string) (model.AuthUser, error) {
	claims := &accessClaims{}
	token, err := jwt.ParseWithClaims(tokenString, claims,
		func(t *jwt.Token) (any, error) {
			// Wajib: cek algoritma eksplisit untuk mencegah algorithm confusion attack
