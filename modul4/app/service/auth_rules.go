...
// ValidateRegister memvalidasi data pendaftaran, mengembalikan map error per field
...
// ValidateLogin hanya memeriksa kelengkapan field, bukan kekuatan password
...
// checkPasswordStrength mengembalikan pesan error atau string kosong jika valid
